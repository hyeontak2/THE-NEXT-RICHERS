  ...
  return (
    <tr className={selected ? "bg-[#fff6df]" : "transition hover:bg-[#fffaf0]"}>
      ...
      <td className="px-4 py-3 align-top">
        ...
        <button
          className="mt-2 inline-flex min-h-8 items-center rounded-[8px] border border-[#c8923d] bg-[#fff4d8] px-2.5 text-xs font-semibold text-[#111411] shadow-sm transition hover:bg-[#f3c56f] whitespace-nowrap"
          type="button"
          onClick={onSelect}
        >
            분석 보기
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <button
            className="mt-3 inline-flex min-h-9 items-center gap-1.5 rounded-[8px] border border-[#c8923d] bg-[#fff4d8] px-3 text-xs font-semibold text-[#111411] shadow-sm transition hover:bg-[#f3c56f] whitespace-nowrap"
            type="button"
            onClick={onSelect}
          >
