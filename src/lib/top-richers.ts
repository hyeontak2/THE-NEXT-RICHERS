...
export const topRichersSource = {
  ...
  informationAsOf: "2026-09-18",
  retrievedAt: "2026-09-18",
  note: "Real-time Forbes data as of 2026-09-18. Stock prices fluctuate daily.",
  stats: {
    totalBillionaires: 3392,
    totalNetWorthTrillion: 20.62,
...
export const topRichers: TopRicher[] = [
  ...
  },
  {
    rank: 11,
    name: "Amancio Ortega",
    netWorthBillion: 133.2,
    netWorthLabel: "$133.2B",
    age: 89,
    country: "스페인",
    category: "패션·리테일",
